...
public plugin_precache()
{
	...
	new const handle[] = "zombie_stone";

	new subclass = rz_subclass_create(handle, class);
	new props = rz_playerprops_create(handle);
	
	rz_subclass_set(subclass, RZ_SUBCLASS_NAME, "RZ_ZOMBIE_STONE_NAME");
	rz_subclass_set(subclass, RZ_SUBCLASS_DESC, "RZ_ZOMBIE_STONE_DESC");
