...
public plugin_precache()
{
	...
	new const handle[] = "human_technodancer";

	new subclass = rz_subclass_create(handle, class);
	new props = rz_playerprops_create(handle);
	
	rz_subclass_set(subclass, RZ_SUBCLASS_NAME, "RZ_HUMAN_TECHNO_NAME");
	rz_subclass_set(subclass, RZ_SUBCLASS_DESC, "RZ_HUMAN_TECHNO_DESC");
